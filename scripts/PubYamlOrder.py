...
if __name__=="__main__":
    ...
    try:
        ...
        yamlpath = rospy.get_param("~yamlpath")      #"/home/haypin/pytest/yamldir"
        launchpath = rospy.get_param("~launchpath")  #"/home/haypin/pytest/launchdir"
        if len(yamlpath)<=0 or len(launchpath)<=0:
            rospy.loginfo(rospy.get_caller_id()+" specified 'yamlpath' or 'launchpath' not valid, exit")
            sys.exit(1)
        else:
